...
sudo mkdir docker/sonarr-config docker/radarr-config docker/lidarr-config docker/readarr-config docker/prowlarr-config docker/qbittorrent-config
sudo mkdir data/torrents data/media
sudo mkdir data/torrents/tv data/torrents/movies data/torrents/music data/torrents/books data/media/tv data/media/movies data/media/music data/media/books
